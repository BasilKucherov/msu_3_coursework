...
def train_triplet(model, loss_fn, optimizer, epoch_n, train_loader, validation_loader, log_file, new_checkpoint_file, last_checkpoint_file=None, device='cpu'):
